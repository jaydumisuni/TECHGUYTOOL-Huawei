...
[nuitka]
mode = onefile
extra_args = --quiet --noinclude-qt-translations=True --include-data-dir=data=data --include-data-dir=assets=assets --include-data-dir=runtime=runtime --windows-console-mode=disable --output-filename=TECHGUY_TOOL_Huawei.exe
