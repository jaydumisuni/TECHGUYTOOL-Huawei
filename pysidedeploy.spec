...
[nuitka]
mode = onefile
extra_args = --quiet --msvc=latest --noinclude-qt-translations --include-data-dir=data=data --include-data-dir=assets=assets --include-data-dir=runtime=runtime --windows-console-mode=disable --output-filename=TECHGUYTOOL_Huawei.exe
