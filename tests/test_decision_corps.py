...
def test_read_only_inspection_continues_despite_identity_contradiction() -> None:
    ...
    assert by_officer["identity.officer"].reason_code == "IDENTITY_CONTRADICTION_READ_ONLY_CONTEXT"
